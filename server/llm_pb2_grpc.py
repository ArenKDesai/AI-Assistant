...
class LLMStub(object):
    ...
    def __init__(self, channel):
        ...
        self.QueryLLM = channel.unary_unary(
                '/LLM/QueryLLM',
                request_serializer=llm__pb2.QueryReq.SerializeToString,
                response_deserializer=llm__pb2.QueryResp.FromString,
...
def add_LLMServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'QueryLLM': grpc.unary_unary_rpc_method_handler(
                    servicer.QueryLLM,
                    request_deserializer=llm__pb2.QueryReq.FromString,
                    response_serializer=llm__pb2.QueryResp.SerializeToString,
            ),
    }
...
class LLM(object):
    ...
    def QueryLLM(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/LLM/QueryLLM',
            llm__pb2.QueryReq.SerializeToString,
            llm__pb2.QueryResp.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
